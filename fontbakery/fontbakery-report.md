...
</div></details><br></div></details><h2>All other checks</h2><details><summary><b>[13] Danfo-Regular.ttf</b></summary><div><details><summary>💔 <b>ERROR:</b> Check Google Fonts glyph coverage. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/glyph_coverage">com.google.fonts/check/glyph_coverage</a>)</summary><div>
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tai-le, syriac, tifinagh, coptic, malayalam, math, canadian-aboriginal, old-permic
 ...
 * U+3008 LEFT ANGLE BRACKET: try adding one of: tai-le, japanese, chinese-simplified, yi, phags-pa, chinese-traditional, chinese-hongkong
 * U+3009 RIGHT ANGLE BRACKET: try adding one of: tai-le, japanese, chinese-simplified, yi, phags-pa, chinese-traditional, chinese-hongkong
